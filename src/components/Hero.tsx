...
export default function Hero() {
  return (
    <section
      className="relative overflow-hidden px-4 pt-[120px] pb-[100px] tablet:px-6 tablet:pt-[160px] tablet:pb-[160px]"
      style={{
        background: "radial-gradient(ellipse 160% 75% at 50% 40%, #F2B5AE 0%, #F5C4BC 15%, #F9D2D2 28%, #FDE8E5 40%, #FEF1EF 50%, #FFF8F7 65%, #FFF8F7 100%)",
      }}
    >
      {/* Glow blobs */}
      <div
      ...
      <div className="relative z-10 mx-auto max-w-[721px] text-center">
        ...
        <h1
          ...
          style={{
            fontSize: "clamp(35.5px, 5.5vw, 57.5px)",
            animationDelay: "0.1s",
        ...
        <p
          className="mx-auto mb-8 tablet:mb-12 max-w-[540px] font-[family-name:var(--font-inter)] font-light text-[15px] leading-[1.7] text-gray-500 animate-fade-in-up"
